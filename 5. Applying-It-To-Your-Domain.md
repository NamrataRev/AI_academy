...
1. Pick a real-world domain you actually care about — healthcare, education, transport, banking, or anything else
2. Apply decomposition, abstraction, and algorithmic thinking from the previous topics to a real problem in that domain
3. Write a clear, focused 3-sentence problem statement
4. Tell the difference between a strong, specific problem statement and a vague one
5. Explain why getting the problem statement right early makes everything else in this program easier
...
- **Education** — "First-year students struggle to get doubt-clearing support outside class hours" is the real problem behind many ed-tech AI tutoring products used across Indian colleges today
- **Agriculture** — "Small farmers in rural India often lack timely, local-language advice on crop disease and pest control" is the problem statement behind several government and startup AI advisory systems
- **Healthcare** — "Patients in rural clinics often wait a long time for a doctor to review basic scan results" has led to AI-assisted triage tools — though healthcare decisions always need careful human oversight
- **Banking / FinTech** — "First-time UPI users often cannot tell whether a payment failure was their own mistake or a technical issue" — much stronger than "banking apps should be smarter"
- **Vernacular AI** — "Many farmers and small business owners are more comfortable describing problems in their regional language than in English or Hindi" — the real problem behind voice-based AI assistants used across India
...
This problem statement is now specific enough to carry forward into Week 2, where you'll turn it into a full, testable AI specification.
...
- This problem statement is the seed of your **Week 15 Capstone project** — the more precise it is now, the smoother every later week will be
