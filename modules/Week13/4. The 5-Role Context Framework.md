...
- Explain the 5-Role Context Framework and its importance for enterprise AI applications.
- Identify the five critical elements: Authority, Exemplar, Constraint, Rubric, and Metadata.
- Construct a production-ready System Prompt combining all five roles.

## Overview

While you can use prompt engineering techniques individually, enterprise-grade AI applications require a structured approach to combining them. This module introduces the **5-Role Context Framework**, a systematic way to construct highly robust, reliable system prompts by ensuring five critical elements of context are present.
...
**Daily-life example:** Imagine hiring a contractor to build a deck. You wouldn't just say "build a deck." You would say you want a licensed professional (**Authority**), show them pictures of decks you like (**Exemplar**), tell them they cannot work past 8 PM (**Constraint**), explain you'll check if the boards are perfectly level (**Rubric**), and give them the exact dimensions of your yard and the local weather forecast (**Metadata**).

**Beginner-friendly way to remember:** Remember it as giving someone the ultimate, foolproof instruction manual, covering who they are, what to do, what not to do, how they will be graded, and what the environment is.
...
The 5-Role Context Framework transforms fragile, unpredictable prompts into robust, production-ready system instructions. By systematically defining Authority, Exemplars, Constraints, Rubrics, and Metadata, you ensure the AI has the complete context needed to perform complex tasks reliably and consistently.

## References

- [Anthropic: Constructing a Prompt](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview)
- [Prompt Engineering Frameworks](https://learnprompting.org/docs/basics/frameworks)
