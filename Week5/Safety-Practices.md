...
---
## User-Level Safety — How You Can Protect Yourself
...
As you learned that AI can hallucinate — confidently stating wrong information. Before acting on any factual claim an AI makes — a statistic, a legal rule, a medical fact, a person's name — verify it against a trusted source. This is especially critical for anything high-stakes.

**Watch for AI impersonation:**

Attackers can use AI to generate highly convincing fake messages, emails, or even voice and video calls pretending to be someone you know. Before acting on any unusual request — especially one involving money, passwords, or sensitive data — verify through a separate, trusted channel. The $25 million deepfake fraud started with a video call that looked completely real.
