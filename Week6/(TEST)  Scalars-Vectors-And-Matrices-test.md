...
### 6.2.1 Student Marks Vector — Worked Example
...
### 6.2.2 Basic Vector Operations — Adding and Scaling
...
### 6.2.3 Why Order Matters — What Goes Wrong If You Mix It Up
...
### 6.2.4 High-Dimensional Vectors — What Real AI Embeddings Look Like
...
## 6.4 A Vector as a Point in Space — Coffee Order Profile Example
...
## 6.5 Scalar vs Vector vs Matrix — Side by Side
...
**Product Matching — E-Commerce Vector Search**

<div style="display:flex;align-items:flex-start;gap:24px;margin:16px 0">
<div style="flex:1">

Modern e-commerce sites don't just match text keywords. They convert both users and products into high-dimensional vectors and compare their positions in space.

If your recent browsing history converts into a vector that points toward `[high_durability, waterproof, winter_wear]`, the search engine finds product vectors that sit closest to your point in that space.

This is why you can search for "sturdy rain jacket" and get a recommendation for a "weatherproof hiking shell" even if the keywords don't match — their vectors are physically close together.
...
```mermaid
flowchart TD
    A["User Profile Vector"] --> C{"Calculate Distance\n(Cosine Similarity)"}
    B["Product Catalog Matrix\n(Many Product Vectors)"] --> C
    C --> D["Return Top 5\nClosest Vectors"]
