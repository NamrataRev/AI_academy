...
In real AI engineering work, you will rarely be handed a single number and asked "is this model good?" — you will be handed a full confusion matrix and asked to compute multiple metrics, weigh their trade-offs, and defend your recommendation.

Getting this wrong has real consequences. Choosing the wrong metric to optimise for can mean a fraud-detection system that misses actual frauds, or a medical-screening AI that gives false reassurance to a sick patient. This topic gives you the tools to make that judgment correctly — with numbers, not just intuition.
