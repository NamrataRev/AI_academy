...
Suppose a spam filter has Precision = 0.70 and Recall = 0.80:
...
The F1 score of 75% sits between 70% and 80% — closer to the lower value, which is intentional. The harmonic mean always pulls toward the weaker of the two numbers, not the middle.
