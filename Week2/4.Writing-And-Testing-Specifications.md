...
## Writing Specifications Across Five Domains
...
## Assigning a Persona (The "Act As" Hack)
...
## Testing a Specification: Did the AI Do What You Asked?

**What Is It?**
Testing means matching the AI's output against your original specification (remember the 15% 'Verify' step from the 70/30 rule). It also connects to the safe-use guardrails from the relevant section — when working with sensitive data, precision, or accountability, your verification step must be even stricter.
...
## The Pre-Flight Checklist (Before You Hit Send)
...
4. **Safety Check:** Does this task involve private data, exact numbers, or legal/medical decisions? If yes, have I applied the right guardrail — anonymisation, verification tools, or expert review? (See the relevant section — How to Use AI Safely.)
