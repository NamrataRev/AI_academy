...
## 2.15 Writing Specifications Across Five Domains
...
## 2.16 Assigning a Persona (The "Act As" Hack)
...
## 2.17 Testing a Specification: Did the AI Do What You Asked?
...
## 2.18 Iterating: Fixing Output Gaps
...
## 2.19 The Pre-Flight Checklist (Before You Hit Send)
