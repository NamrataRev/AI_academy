# The Professional Rules of AI Use
...
Using AI effectively is not just about knowing how to type a prompt; it is about knowing *when* and *how* to rely on it. Professionals do not let AI do 100% of the work. They use a structured approach, keeping control of the direction and taking responsibility for the final output. This topic covers the core rules of using AI safely and professionally in any job.

## 2.5 The 70/30 Rule: AI Implements, You Specify and Verify

**What Is It?**
The 70/30 rule is a simple guideline for dividing work between you and the AI. AI should do about 70% of the heavy lifting (writing, coding, summarising), but YOU must do the critical 30%: providing the specific instructions at the start, and verifying the results at the end.

**👨‍💼 Think of it like this:** Imagine you are a manager and the AI is your smart, but sometimes overconfident, intern. You would not just tell an intern "write a report" and send it to the CEO without reading it. You give the intern specific instructions (specify), let them do the drafting (implement), and then you review and fix their mistakes before sending (verify).

**The Breakdown:**

- **15% Specify (You):** Give clear, detailed instructions. Set the boundaries, context, and goal.
- **70% Implement (AI):** The AI generates the code, writes the email, or drafts the document.
- **15% Verify (You):** Check for errors, adjust the tone, and ensure it actually solves the original problem.
