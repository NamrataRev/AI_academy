...
**Think about how Google Photos recognises vehicles.** When you upload a photo of a vehicle, the app doesn't just say "that is definitely a car." It calculates a confidence score for every possibility:

- Car — 85% confident
- Truck — 10% confident
- Bus — 5% confident

Notice that 85 + 10 + 5 = 100%. The model always spreads its confidence across all possibilities so the total adds up to 100%. It is not saying "this is definitely a car." It is saying "if I had to bet, I would put 85% of my money on car." LLMs work the exact same way — for every word they might generate next.
