...
## 3.1 Era 1 — Traditional AI (1950s–1980s): Write Every Rule by Hand
...
## 3.2 Era 2 — Machine Learning (1980s–2010s): Let the Computer Find the Rules
...
## 3.3 Era 3 — Deep Learning (2010s–present): Many Layers, Much More Powerful
...
## 3.4 The Rise of Large Language Models (LLMs)
...
## 3.7 How to classify any AI system — ask three questions:
